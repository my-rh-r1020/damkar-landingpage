<section class="section-layout bg-lightGrey">
    <div class="main-layout flex flex-wrap">
        <div class="container-layout md:w-10/12 lg:w-9/12 xl:w-8/12">
            ...
            <div class="pt-1 pb-6">
                <img src="" alt="edukasi-image" class="w-full">
            </div>
            <article class="text-justify text-sm lg:text-base text-blackColor mb-16">
                <p class="mb-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quod earum accusamus quos molestiae quam numquam omnis debitis corporis quo molestias.</p>
            </article>
        </div>
    </div>
</section>