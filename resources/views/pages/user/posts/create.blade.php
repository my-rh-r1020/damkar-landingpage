...
<div class="w-full lg:w-7/12">
    <form action="{{ route('articles.store') }}" method="post">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="title" name="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm lg:text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Judul Artikel Baru" required>
        </div>
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <input id="content_text" type="hidden" name="content">
        ...
        <div class="mb-10">
            <label for="slug" class="block mb-2 text-sm lg:text-base font-medium text-gray-900">Link Artikel</label>
            <input type="text" id="slug" name="slug" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm lg:text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Link Artikel Baru" required readonly>
        </div>
