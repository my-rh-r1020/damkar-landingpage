...
<div class="mb-10">
    <h3 class="font-semibold text-xl md:text-2xl xl:text-3xl">Form Regu</h3>
</div>
<div class="w-full lg:w-7/12">
    <form action="{{ route('regu.store') }}" method="post">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="nama_regu" name="nama_regu" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm lg:text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Nama Regu Baru" required>
        </div>
        <div class="mb-10">
            <label for="lokasi" class="block mb-2 text-sm lg:text-base font-medium text-gray-900">Lokasi Regu</label>
            <input type="text" id="lokasi" name="lokasi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm lg:text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Lokasi Regu Baru" required>
        </div>
