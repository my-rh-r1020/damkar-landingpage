...
<div class="mb-5">
    <a href="{{ route('regu.create') }}" class="px-3 py-2 rounded-md bg-blue-500 hover:bg-blue-600 text-white text-base">Add Regu</a>
</div>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b hover:bg-gray-50 text-gray-800">
                ...
                <td class="flex items-center px-6 py-4 space-x-3">
                    <a href="/dashboard/regu/{{ $regu->id }}" class="font-medium text-slate-500 hover:text-slate-700"><i class='bx bx-show text-xl'></i></a>
