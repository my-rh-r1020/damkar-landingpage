<section class="section-layout">
    <div class="main-layout w-full">
        <div class="lg:mx-[83px] xl:mx-[127px] flex flex-wrap">
            <div class="font-semibold pb-[40px] px-[15px]">
            ...
            <div class="px-[15px] text-justify">
                <article>
            ...
            <div class="mt-12 mb-16 mx-[15px] w-full">
            ...
            <div class="py-7 mx-[15px] flex w-full justify-between border border-white border-t-slate-300 border-b-slate-300">
                <div>
                    <a href="#">
